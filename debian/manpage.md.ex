% alex-rs232-reader(SECTION) | User Commands
%
% "January 26 2024"
...
alex-rs232-reader - program to do something

# SYNOPSIS

**alex-rs232-reader** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**alex-rs232-reader** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **alex-rs232-reader** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**alex-rs232-reader** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    alex-rs232-reader. See **foo.conf**(5) for further details.
...
**alex-rs232-reader** provides some return codes, that can be used in scripts:
